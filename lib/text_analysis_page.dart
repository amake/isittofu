          ...
          children: <Widget>[
            Row(
              children: <Widget>[
                ...
                _HelpToggleButton(expanded),
              ],
            ),
            Padding(
              padding: const EdgeInsets.only(top: 8, bottom: 16),
              child: _ExpandableHelpText(expanded),
            ),
            Container(
...
class _HelpToggleButton extends StatelessWidget {
  const _HelpToggleButton(this.enabled, {Key key})
      : assert(enabled != null),
        super(key: key);
...
class _ExpandableHelpText extends StatelessWidget {
  const _ExpandableHelpText(this.expanded, {Key key})
